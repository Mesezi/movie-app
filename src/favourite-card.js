...
<img className='backdrop none' src={props.backdrop}/>
...
<span onClick={()=>props.remove(props.id)}><img src={props.like? imgLiked : mode ? imgNotLikedDark : imgNotLikedLight} /></span></div>
   <p>"{props.overview}"</p>
